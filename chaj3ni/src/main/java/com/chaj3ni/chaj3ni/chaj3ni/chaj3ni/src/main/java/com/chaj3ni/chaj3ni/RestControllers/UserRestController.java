...
import com.chaj3ni.chaj3ni.RestControllers.service.UserService;
...
public class UserRestController {
    ...
    public User ajouterAdmin (@RequestBody User admin){
        return userService.ajouterUser(admin);}
